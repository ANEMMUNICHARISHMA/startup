...
export default function LeadDrawer({ leadId, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden flex justify-end">
      ...
      <div className="relative w-full max-w-xl h-full bg-white dark:bg-[#0f172a] border-l border-slate-200 dark:border-slate-800 shadow-2xl flex flex-col z-10 transition-transform duration-300 ease-out transform translate-x-0">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {/* Main Info Matrix */}
          <div className="grid grid-cols-2 gap-4 p-4 rounded-xl border border-slate-200 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-900/20">
            {/* Stage Selector */}
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full h-8.5 px-2 text-xs font-semibold text-slate-800 dark:text-slate-200 bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 rounded-lg outline-none cursor-pointer focus:border-blue-500"
              >
                {STAGES.map((s) => (
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-8.5 pl-7 pr-3 text-xs font-semibold text-slate-800 dark:text-slate-200 bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 rounded-lg outline-none focus:border-blue-500"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full h-8.5 px-2 text-xs font-medium text-slate-800 dark:text-slate-200 bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 rounded-lg outline-none cursor-pointer focus:border-blue-500"
              >
                {OWNERS.map((o) => (
            ...
            <div className="space-y-1.5">
              ...
              <div className="w-full h-8.5 flex items-center px-3 text-xs font-semibold text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800/80 rounded-lg border border-transparent">
                {lead.source}
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-semibold text-slate-900 dark:text-slate-50 uppercase tracking-wider">
              Contact Card
            </h4>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={4}
              className="w-full p-3 text-xs text-slate-800 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 bg-slate-50 hover:bg-slate-100/50 dark:bg-[#111827]/40 dark:hover:bg-[#111827]/60 border border-slate-200 dark:border-slate-800/85 focus:border-blue-500 dark:focus:border-blue-600 rounded-lg outline-none resize-none transition-all leading-relaxed"
            />
          </div>

          {/* Activity Logs Timeline */}
          <div className="space-y-4 pt-4 border-t border-slate-200 dark:border-slate-800/80">
            <h4 className="text-xs font-semibold text-slate-900 dark:text-slate-50 uppercase tracking-wider flex items-center gap-1.5">
            ...
            <form onSubmit={handleAddLogSubmit} className="flex gap-2">
              <input
                ...
                className="flex-1 h-8.5 px-3 text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 focus:border-blue-500 dark:focus:border-blue-600 rounded-lg outline-none transition-all"
              />
              <button
                type="submit"
            ...
            {/* Timeline display */}
            <div className="space-y-4 pl-3.5 border-l border-slate-200 dark:border-slate-800 relative mt-4">
